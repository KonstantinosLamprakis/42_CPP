...
/*   Updated: 2024/05/09 16:18:12 by klamprak         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
FragTrap::FragTrap()
{
	std::cout << "FragTrap default empty constructor of " << this->getName() << std::endl;
}
...
{
	std::cout << "FragTrap " << this->getName() << " give a big HiFive to every one, new nrgpoints: " << this->getNrgPoints() - 1 << std::endl;
}
