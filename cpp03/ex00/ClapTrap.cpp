...
/*   Updated: 2024/05/09 15:40:47 by klamprak         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
ClapTrap::~ClapTrap()
{
	std::cout << "Distructor of " << this->_name << std::endl;
}
...
void ClapTrap::attack(const std::string& target)
{
	...
	{
		std::cout << "Not enough energy points for " << this->_name << " to attack " << target << std::endl;
		return ;
	}
	std::cout << this->_name << " attacks to " << target << " causing damage of " << this->_attackDamage << std::endl;
	this->_nrgPoints--;
